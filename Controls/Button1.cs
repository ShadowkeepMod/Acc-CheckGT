...
namespace AccCheck.Controls
{
    public class Button1 : Control
    {
        ...
        public bool Mousepressed = Form1.ButtonPanelState == 2 ?  true : false;
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
            ...
            Form1.ButtonPanelState = 2;
            Mousepressed = Form1.ButtonPanelState == 2 ? true : false;
            //Form1.ButtonPanelState = 2;
